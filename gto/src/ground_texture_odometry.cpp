...
namespace groud_texture_odometry{
  ...
  GroundTextureOdometry::GroundTextureOdometry(): private_nh_("~"), rate(30)
  {
    ...
    keypoint_publisher_ = nh_.advertise<sensor_msgs::Image>("I_keypoint_publisher", 10, true);
    matcher_publisher_ = nh_.advertise<sensor_msgs::Image>("II_matcher_publisher", 10, true);
    selected_keypoint_publisher_ = nh_.advertise<sensor_msgs::Image>("III_selected_keypoint_publisher", 10, true);
    selected_keypoint_matcher_publisher_ = nh_.advertise<sensor_msgs::Image>("IV_selected_keypoint_matcher_publisher", 10, true);
  ...
  void GroundTextureOdometry::process()
  {
    ...
    transform_msgs.child_frame_id = "odom";
